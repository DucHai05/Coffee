...
export const productApi = {
    ...
    delete: (id) => axios.delete(`${GATEWAY_URL}/api/product/v1/san-pham/${id}`),
    update: (id, data) => axios.put(`${GATEWAY_URL}/api/product/v1/san-pham/${id}`, data),
};
...
export const salaryApi = {
    ...
    fixCaLoi: (data, token) => axios.put(`${GATEWAY_URL}/api/salary/cham-cong/fix-ca-loi`, data, {
        headers: { Authorization: `Bearer ${token}` }
    }),
};
