...
const OrderPage = () => {
    ...
    const autoDiscountVal = React.useMemo(() => {
        ...
        if (!CartHelpers.validatePromotion(autoDiscount, subTotal, cart).valid) return 0;
    ...
    const manualDiscountVal = React.useMemo(() => {
        ...
        if (!CartHelpers.validatePromotion(manualDiscount, subTotal, cart).valid) return 0;
